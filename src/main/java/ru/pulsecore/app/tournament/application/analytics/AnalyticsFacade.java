...
public class AnalyticsFacade {
    ...
    private final TournamentIncomeService tournamentIncomeService;
    ...
    public MonthlyIncomeResponse getMonthlyIncome(UUID playerId, int year) {
        return tournamentIncomeService.getMonthlyIncome(playerId, year);
    }
    ...
    public DailyIncomeResponse getDailyIncome(UUID playerId, int year, int month) {
        return tournamentIncomeService.getDailyIncome(playerId, year, month);
    }
