package ru.pulsecore.app.tournament.application.tournament.extraction;
...
import ru.pulsecore.app.tournament.domain.NightBonusService;
...
import ru.pulsecore.app.tournament.domain.RemovedResult;
import ru.pulsecore.app.tournament.domain.TournamentContext;
import ru.pulsecore.app.tournament.domain.TournamentStatus;
