...
import ru.pulsecore.app.modules.player_modeles.api.dto.request.OAuthFinishRequest;
import ru.pulsecore.app.modules.player_modeles.application.auth.PlayerLoginService;
import ru.pulsecore.app.modules.player_modeles.application.auth.RegistrationMailPublisher;
import ru.pulsecore.app.modules.player_modeles.infrastructure.exception.OAuthEmailNotReceivedException;
import ru.pulsecore.app.modules.player_modeles.entity.Player;
import ru.pulsecore.app.modules.player_modeles.application.subscription.TrialActivator;
