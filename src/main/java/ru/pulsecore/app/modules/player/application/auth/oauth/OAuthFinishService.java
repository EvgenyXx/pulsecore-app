package ru.pulsecore.app.modules.player.application.auth.oauth;
...
import ru.pulsecore.app.modules.player.application.auth.PlayerLoginService;
import ru.pulsecore.app.modules.player.application.auth.RegistrationMailPublisher;
import ru.pulsecore.app.modules.player.infrastructure.exception.OAuthEmailNotReceivedException;
import ru.pulsecore.app.modules.player.entity.Player;
import ru.pulsecore.app.modules.player.application.subscription.TrialActivator;
