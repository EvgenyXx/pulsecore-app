...
import ru.pulsecore.app.modules.player.api.dto.response.DashboardResponse;
import ru.pulsecore.app.modules.player.api.dto.response.LastResultDto;
import ru.pulsecore.app.modules.player.api.dto.response.SubscriptionInfoDto;
import ru.pulsecore.app.modules.player.api.dto.response.UpcomingLineupDto;
...
public class DashboardService {
    ...
    private LastResultDto getLastResult(Player player) {
        return tournamentResultRepository.findTopByPlayerIdOrderByDateDesc(player.getId())
